                    ...
                    <table class="table table-lightbor table-lightfont">
                      <tr>      
                        ...
                        <?php
                            ...
                            <strong> Required:</strong> <span class="install4">- application/config/database.php to be writtable</span> <i class="picons-thin-icon-thin-0154_ok_successful_check install2"></i>
                        <?php else:?>
                          <strong> Required:</strong> <span class="red">- application/config/database.php to be writtable</span> <i class="picons-thin-icon-thin-0153_delete_exit_remove_close install3"></i>
                        <?php endif;?>
                        </td>
                      </tr>
                      <tr>      
                        ...
                        <?php
                          ...
                          <strong> Required:</strong> <span class="install4">- application/config/routes.php to be writtable</span> <i class="picons-thin-icon-thin-0154_ok_successful_check install2"></i>
                        <?php else:?>
                            <strong> Required:</strong> <span class="red">- application/config/routes.php to be writtable</span> <i class="picons-thin-icon-thin-0153_delete_exit_remove_close install3"></i>
                        <?php endif;?>
                    </td>
                      </tr>
                      <tr>      
                        ...
                        <?php
                          ...
                          <strong> Required:</strong> <span class="install4">- php CURL function enabled</span> <i class="picons-thin-icon-thin-0154_ok_successful_check install2"></i>
                          <?php else:?>
                              <strong> Required:</strong> <span class="red">- php CURL function enabled</span> <i class="picons-thin-icon-thin-0153_delete_exit_remove_close install2"></i>
                          <?php endif;?>
                        </td>
                      </tr>
                    </table>
