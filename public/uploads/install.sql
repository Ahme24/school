...
-- Tiempo de generación: 19-07-2022 a las 15:16:31
...
CREATE TABLE IF NOT EXISTS `frontend` (
  `frontend_id` int(11) NOT NULL AUTO_INCREMENT,
...
) ENGINE=MyISAM AUTO_INCREMENT=3828 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
